...
<me:tranghome title="Add new publisher">
	...
	<p>${message}</p>
	<form action="EditPublisherServlet" method="post" style="margin-left:20px;">
		<p><label>Name</label><input type="text" name="publisherName" value="${p.publisherName}">
		<input type="hidden" value="${p.publisherId}" name="id">
