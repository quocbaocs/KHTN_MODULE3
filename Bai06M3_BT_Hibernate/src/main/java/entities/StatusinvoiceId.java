...
/**
 * StatusinvoiceId generated by hbm2java
 */
@Embeddable
public class StatusinvoiceId implements java.io.Serializable {

	private byte statusId;
	private String statusName;

	public StatusinvoiceId() {
	}

	public StatusinvoiceId(byte statusId, String statusName) {
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof StatusinvoiceId))
			return false;
		StatusinvoiceId castOther = (StatusinvoiceId) other;
