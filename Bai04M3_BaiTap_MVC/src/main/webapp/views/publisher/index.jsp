...
<tr>
<td><button class="btn btninfo">Delete</button> </td>
<th>Id</th>
<th>Name</th>
<th>Edit</th>
<th>Delete</th>
...
<td>
<a
							href="${pageContext.request.contextPath}/admin/publisher/edit.html?id=${o.id}">
<img src="${pageContext.request.contextPath}/images/edit.png" alt="Edit">
</a>
</td>
<td>
<a
							href="${pageContext.request.contextPath}/admin/publisher/del.html?id=${o.id}">
