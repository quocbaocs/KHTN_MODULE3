...
<body>
	...
	<form action="" method="get">
		<table class="styleh">
			...
			<tr align="center" style="padding-bottom: 15px; background-color: #D3D3D3;">
				<td><b>Loại sữa: </b> <select name="loai">
						<%
						...
						%>
				</select> &nbsp; <b>Hãng sữa: </b> <select name="hang">
						<%
	...
	if (request.getParameter("keyword") != null) {
		...
		//stm = kn.createStatement();
		sql += " AND SUA.TEN_SUA LIKE '%" + request.getParameter("keyword") + "%' AND SUA.MA_HANG_SUA ='" + hang + "' AND"
		+ " SUA.MA_LOAI_SUA='" + loai + "'";
		;
